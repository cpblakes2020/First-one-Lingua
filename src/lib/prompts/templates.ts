...
export const promptTemplates: readonly PromptTemplate[] = [
  ...
  { id: "flashcards", name: "Make flashcards", description: "Anki-ready, reversible by default", instruction: "Create concise flashcard entries suitable for Anki, with reversible front and back directions." },
